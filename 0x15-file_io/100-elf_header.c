 ...
 * @argc: The quantity of input parameters provided to the program.
 * @argv: A collection of pointers pointing to the arguments.
 *
 * Return: 0 on success.
 * Description: If the file is neither an ELF File nor the function succeeds
 * an exit code of 98 will be returned.
 */
